 ...
 * @author Jasmine
 */
public class OldFactoryManagerWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public OldFactoryManagerWorkAreaJPanel(JPanel container, UserAccount userAccount, FactoryOrganization organization, Enterprise enterprise, EcoSystem system) {
        initComponents();
...
//        System.out.println(userAccount.getEmployee().getPhoto());
    ...
    private void initComponents() {
        ...
        vaccineRequestTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Vaccine", "Request ID", "Doses Request", "Sender", "Status"
            }
        ));
        ...
        vaccineProduceTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Vaccine", "REQUEST ID", "Vaccine ID", "Doses", "Manufacture Date", "Expiration Date"
            }
        ));
        vaccineProduceTable.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jScrollPane2.setViewportView(vaccineProduceTable);
        if (vaccineProduceTable.getColumnModel().getColumnCount() > 0) {
            vaccineProduceTable.getColumnModel().getColumn(4).setMinWidth(200);
            vaccineProduceTable.getColumnModel().getColumn(5).setMinWidth(200);
        }
